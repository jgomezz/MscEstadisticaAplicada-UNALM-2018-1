...
# Read file
banco <- read.csv(FILE_URL, header=TRUE, fileEncoding = FILE_ENCONDING )
...
plot(density(Ingreso,kernel="gaussian"),col="blue",main="Gráfico de Densidad",xlab="Número de clientes",ylab="Cantidad")

plot(density(SB$Ingreso,kernel="gaussian"),col="blue",main="Gráfico de San Borja",xlab="Número de clientes",ylab="Cantidad")
plot(density(SI$Ingreso,kernel="gaussian"),col="red",main="Gráfico de San Isidro",xlab="Número de clientes",ylab="Cantidad")
plot(density(SL$Ingreso,kernel="gaussian"),col="green",main="Gráfico de San Luis",xlab="Número de clientes",ylab="Cantidad")
...
###################
library(vcd)
mosaicplot(~ Sucursal+Genero, data = banco, color = 2:3, main="Distribución del Género según sucursal")
...
scatterplot3d(banco[,3:6],main="Gráfico de Dispersión 3D")
...
parcoord(banco[1:21,3:6],col=1 + (0:20)%/%7)  # se usa el modulo de 7 porque los datos estan agrupados por un multiplo de 7 (21)
